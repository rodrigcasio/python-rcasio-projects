# Generated by Django 4.2.4 on 2025-12-16 14:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data_enrolled', models.DateField(default=django.utils.timezone.now)),
        ...
        migrations.AddField(
            model_name='course',
            name='learner',
            field=models.ManyToManyField(through='related_objects.Enrrollment', to='related_objects.learner'),
        ),
    ]
